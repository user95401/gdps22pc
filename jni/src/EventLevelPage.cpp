...
bool EventLevelPage::init() {
	...
	m_pLayer->runAction(CCEaseElasticOut::create(CCMoveTo::create(0.5f, CCMenu::create()->getPosition()), 0.6f));//:facepalm:
	...
	CCSprite* dailyLevelCorner1 = CCSprite::createWithSpriteFrameName("dailyLevelCorner_001.png");
	dailyLevelCorner1->setPosition({ -185.500f, -115.500f });
	m_pLayer->addChild(dailyLevelCorner1);

	CCSprite* dailyLevelCorner2 = CCSprite::createWithSpriteFrameName("dailyLevelCorner_001.png");
	dailyLevelCorner2->setPosition({ -185.500f, 115.500f });
	dailyLevelCorner2->setScaleY(-1);
	m_pLayer->addChild(dailyLevelCorner2);

	CCSprite* dailyLevelCorner3 = CCSprite::createWithSpriteFrameName("dailyLevelCorner_001.png");
	dailyLevelCorner3->setPosition({ 185.500f, -115.500f });
	dailyLevelCorner3->setScaleX(-1);
	m_pLayer->addChild(dailyLevelCorner3);

	CCSprite* eventLevelLabel_001 = CCSprite::createWithSpriteFrameName("eventLevelLabel_001.png");
	eventLevelLabel_001->setPosition({ 0.0f, 110.000f });
	m_pLayer->addChild(eventLevelLabel_001);

	m_pButtonMenu->addChild(CCMenuItemSpriteExtra::create(CCSprite::createWithSpriteFrameName("GJ_closeBtn_001.png"), CCSprite::createWithSpriteFrameName("GJ_closeBtn_001.png"), this, menu_selector(EventLevelPage::onClose)));
	m_pButtonMenu->setPosition({ -200.000f, 130.000f });
	auto historyBtn = CCMenuItemSpriteExtra::create(CCSprite::createWithSpriteFrameName("GJ_safeBtn_001.png"),CCSprite::createWithSpriteFrameName("GJ_safeBtn_001.png"),this,nullptr);
