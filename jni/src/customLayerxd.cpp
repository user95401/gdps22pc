...
void customLayerxd::openURLcredits(CCObject* sender) { CCApplication::sharedApplication()->openURL("http://gdps22pc.cxgame.ru/credits.php"); }
...
void customLayerxd::openURL(CCObject* sender) { CCApplication::sharedApplication()->openURL("http://gdps22pc.cxgame.ru"); }
void customLayerxd::discord_openURL(CCObject* sender) { CCApplication::sharedApplication()->openURL("https://discord.gg/hC9JsVE7Pc"); }
...
bool customLayerxd::init() {
    ...
    auto backgroundSprite = CCSprite::create("shopBG_001.png");
    ...
    //bese yp
    auto Mod_logo_001 = CCSprite::createWithSpriteFrameName("Mod_logo_001.png");
    ...
    auto treasureRoomSpiderweb_001 = CCSprite::createWithSpriteFrameName("treasureRoomSpiderweb_001.png");
